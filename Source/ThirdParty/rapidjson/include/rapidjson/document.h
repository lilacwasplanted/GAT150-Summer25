...
public:
  ...
  */
  ...
  // swap() for sort() and other potential use in STL.
...
#ifdef __cpp_lib_three_way_comparison
  template <bool Const_> strong_ordering operator<=>(const GenericMemberIterator<Const_, Encoding, Allocator>& that) const { return ptr_ <=> that.ptr_; }
#endif
  //@}
...
*/
template<typename CharType>
inline GenericStringRef<CharType> StringRef(const basic_string<CharType>& str) {
...
#if RAPIDJSON_HAS_STDSTRING
template<typename ValueType> 
struct TypeHelper<ValueType, basic_string<typename ValueType::Ch> > {
  typedef basic_string<typename ValueType::Ch> StringType;
  static bool Is(const ValueType& v) { return v.IsString(); }
...
public:
  ...
  */
  ...
  /*! \note Requires the definition of the preprocessor symbol \ref RAPIDJSON_HAS_STDSTRING.
   */
  GenericValue(const basic_string<Ch>& s, Allocator& allocator) : data_() { SetStringRaw(StringRef(s), allocator); }
#endif
  ...
  */
  ...
  /*!
    Helper function to enable support for common swap implementation pattern based on \c swap:
    \code
  ...
  */
  ...
  /*! \note Requires the definition of the preprocessor symbol \ref RAPIDJSON_HAS_STDSTRING.
   */
  bool operator==(const basic_string<Ch>& rhs) const { return *this == GenericValue(StringRef(rhs)); }
#endif
  ...
  */
  ...
  bool IsLosslessDouble() const {
    ...
    if (IsUint64()) {
      ...
      return (d >= 0.0)
        && (d < static_cast<double>(( numeric_limits<uint64_t>::max)()))
        && (u == static_cast<uint64_t>(d));
    }
    if (IsInt64()) {
      int64_t i = GetInt64();
      volatile double d = static_cast<double>(i);
      return (d >= static_cast<double>(( numeric_limits<int64_t>::min)()))
  ...
  bool IsLosslessFloat() const {
    if (!IsNumber()) return false;
    double a = GetDouble();
    if (a < static_cast<double>(-( numeric_limits<float>::max)())
        || a > static_cast<double>(( numeric_limits<float>::max)()))
      return false;
  ...
  */
  ...
  GenericValue& operator[](const basic_string<Ch>& name) { return (*this)[GenericValue(StringRef(name))]; }
  const GenericValue& operator[](const basic_string<Ch>& name) const { return (*this)[GenericValue(StringRef(name))]; }
#endif
  ...
  */
  ...
  /*!
    ...
    \note Linear time complexity.
  */
  bool HasMember(const basic_string<Ch>& name) const { return FindMember(name) != MemberEnd(); }
#endif
  ...
  */
  ...
  /*!
    ...
    \note Earlier versions of Rapidjson returned a \c NULL pointer, in case
      ...
      \c map, this has been changed to MemberEnd() now.
    \note Linear time complexity.
  */
  ...
  */
  ...
  /*!
    ...
    \return Iterator to member, if it exists.
      Otherwise returns \ref MemberEnd().
  */
  MemberIterator FindMember(const basic_string<Ch>& name) { return FindMember(GenericValue(StringRef(name))); }
  ConstMemberIterator FindMember(const basic_string<Ch>& name) const { return FindMember(GenericValue(StringRef(name))); }
#endif
  ...
  */
  ...
  /*! \param name A string value as name of member.
    ...
    \note Amortized Constant time complexity.
  */
  GenericValue& AddMember(GenericValue& name, basic_string<Ch>& value, Allocator& allocator) {
...
#if RAPIDJSON_HAS_STDSTRING
  bool RemoveMember(const basic_string<Ch>& name) { return RemoveMember(GenericValue(StringRef(name))); }
#endif
...
#if RAPIDJSON_HAS_STDSTRING
  bool EraseMember(const basic_string<Ch>& name) { return EraseMember(GenericValue(StringRef(name))); }
#endif
  ...
  */
  ValueIterator Erase(ConstValueIterator first, ConstValueIterator last) {
    ...
    for (ValueIterator itr = pos; itr != last; ++itr)
      itr->~GenericValue();
     memmove(static_cast<void*>(pos), last, static_cast<size_t>(End() - last) * sizeof(GenericValue));
  ...
  */
  ...
  /*! \param s source string.
    ...
    \note Requires the definition of the preprocessor symbol \ref RAPIDJSON_HAS_STDSTRING.
  */
  GenericValue& SetString(const basic_string<Ch>& s, Allocator& allocator) { return SetString(StringRef(s), allocator); }
#endif
  ...
  /*!
    \tparam T Either \c bool, \c int, \c unsigned, \c int64_t, \c uint64_t, \c double, \c float, \c const \c char*, \c basic_string<Ch>
  */
  template <typename T>
...
private:
  ...
  struct MapTraits {
    struct Less {
      bool operator()(const Data& s1, const Data& s2) const {
        ...
        int cmp = memcmp(DataString(s1), DataString(s2), sizeof(Ch) * (n1 < n2 ? n1 : n2));
        return cmp < 0 || (cmp == 0 && n1 < n2);
      }
    };
    typedef pair<const Data, SizeType> Pair;
    typedef multimap<Data, SizeType, Less, StdAllocator<Pair, Allocator> > Map;
    ...
    if (!oldMap) {
      ...
      *newMap = *oldMap;
      size_t count = (*oldMap)->size();
       memcpy(static_cast<void*>(GetMapMembers(*newMap)),
  ...
  MemberIterator DoEraseMembers(ConstMemberIterator first, ConstMemberIterator last) {
    ...
    if (first != last) {
      ...
      for (MemberIterator itr = pos; next != end; ++itr, ++next) {
         memcpy(static_cast<void*>(&*itr), &*next, sizeof(Member));
...
#else
     memmove(static_cast<void*>(&*pos), &*last,
  ...
  void SetArrayRaw(GenericValue* values, SizeType count, Allocator& allocator) {
    ...
    if (count) {
      ...
      SetElementsPointer(e);
       memcpy(static_cast<void*>(e), values, count * sizeof(GenericValue));
    }
    else
  ...
  void SetObjectRaw(Member* members, SizeType count, Allocator& allocator) {
    ...
    if (count) {
      ...
      SetMembersPointer(m);
       memcpy(static_cast<void*>(m), members, count * sizeof(Member));
#if RAPIDJSON_USE_MEMBERSMAP
      Map* &map = GetMap(m);
      MapIterator* mit = GetMapIterators(map);
      for (SizeType i = 0; i < count; i++) {
  ...
  void SetStringRaw(StringRefType s, Allocator& allocator) {
    ...
    if (ShortString::Usable(s.length)) {
      ...
      str = data_.ss.str;
       memmove(str, s, s.length * sizeof(Ch));
    } else {
...
public:
  ...
  */
  ...
  GenericDocument(GenericDocument&& rhs) RAPIDJSON_NOEXCEPT
    : ValueType( forward<ValueType>(rhs)), // explicit cast to avoid prohibited move from Document
  ...
  GenericDocument& operator=(GenericDocument&& rhs) RAPIDJSON_NOEXCEPT
  {
    ...
    ValueType::operator=( forward<ValueType>(rhs));
...
#if RAPIDJSON_HAS_STDSTRING
  template <unsigned parseFlags, typename SourceEncoding>
  GenericDocument& Parse(const basic_string<typename SourceEncoding::Ch>& str) {
    // c_str() is constant complexity according to standard. Should be faster than Parse(const char*, size_t)
    return Parse<parseFlags, SourceEncoding>(str.c_str());
  }

  template <unsigned parseFlags>
  GenericDocument& Parse(const basic_string<Ch>& str) {
...
#if RAPIDJSON_HAS_STDSTRING
  ValueType& operator[](const basic_string<Ch>& name) const { return value_[name]; }
#endif
...
#if RAPIDJSON_HAS_STDSTRING
  bool HasMember(const basic_string<Ch>& name) const { return value_.HasMember(name); }
#endif
  template <typename SourceAllocator> bool HasMember(const GenericValue<EncodingType, SourceAllocator>& name) const { return value_.HasMember(name); }
  MemberIterator FindMember(const Ch* name) const { return value_.FindMember(name); }
  template <typename SourceAllocator> MemberIterator FindMember(const GenericValue<EncodingType, SourceAllocator>& name) const { return value_.FindMember(name); }
#if RAPIDJSON_HAS_STDSTRING
  MemberIterator FindMember(const basic_string<Ch>& name) const { return value_.FindMember(name); }
#endif
  GenericObject AddMember(ValueType& name, ValueType& value, AllocatorType& allocator) const { value_.AddMember(name, value, allocator); return *this; }
  GenericObject AddMember(ValueType& name, StringRefType value, AllocatorType& allocator) const { value_.AddMember(name, value, allocator); return *this; }
#if RAPIDJSON_HAS_STDSTRING
  GenericObject AddMember(ValueType& name, basic_string<Ch>& value, AllocatorType& allocator) const { value_.AddMember(name, value, allocator); return *this; }
#endif
...
#if RAPIDJSON_HAS_STDSTRING
  bool RemoveMember(const basic_string<Ch>& name) const { return value_.RemoveMember(name); }
#endif
...
#if RAPIDJSON_HAS_STDSTRING
  bool EraseMember(const basic_string<Ch>& name) const { return EraseMember(ValueType(StringRef(name))); }
#endif
